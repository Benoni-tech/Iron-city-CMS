...
export const metadata: Metadata = {
  title: "Our Beliefs",
  description: "The Statement of Faith of Iron City Church of Christ.",
}

const fallbackBelief = {
  type: "doc" as const,
  content: [
    {
      type: "paragraph",
      content: [{ type: "text", text: "The Statement of Faith for Iron City Church of Christ will be written here. Edit this from the Site Config section of the admin dashboard." }],
    },
  ],
}
...
export default async function OurBeliefsPage() {
  ...
  const belief = config?.aboutBelief ?? fallbackBelief
